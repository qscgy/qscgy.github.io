...
- Managed a team of 6 TAs to ensure consistent availability of support to students.
...
**Programming:** Python (NumPy, SciPy, Pandas, Matplotlib, PyTorch, Pytorch3D, OpenCV, Altair,
